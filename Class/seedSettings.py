...
from Module import attackDataPresets
...
from Module.attackDataPresets import AttackDataPresets
...
_all_settings = [
    ...
    Toggle(
        name=settingkey.ABILITY_AP_RANDO,
        group=SettingGroup.SEED_MODIFIERS,
        ui_label="Randomize Ability AP Costs",
        shared=True,
        default=False,
        tooltip="Randomizes the ability AP costs for Sora. Warning: abilities with AP cost of zero cannot be toggled on or off.",
    ),
    IntSpinner(
        name=settingkey.ABILITY_MIN_AP_VALUE,
        group=SettingGroup.SEED_MODIFIERS,
        ...
        step=1,
        default=1,
        tooltip="Minimum AP cost for Sora's abilities. Warning: abilities with AP cost of zero cannot be toggled on or off.",
    ),
    IntSpinner(
        ...
        step=1,
        default=5,
        tooltip="Maximum AP cost for Sora's abilities.",
    ),
    Toggle(
    ...
    MultiSelect(
        name=settingkey.ENABLED_KEYBLADE_LOCKING_WORLDS,
        group=SettingGroup.SEED_MODIFIERS,
        ui_label="Enabled Keyblade Locked Worlds",
        choices={
            locationType.STT: f"{locationType.STT}",
            locationType.TT: f"{locationType.TT}",
            locationType.CoR: f"{locationType.CoR}",
            locationType.HB: f"{locationType.HB}",
            locationType.BC: f"{locationType.BC}",
            locationType.OC: f"{locationType.OC}",
            locationType.Agrabah: f"{locationType.Agrabah}",
            locationType.LoD: f"{locationType.LoD}",
            locationType.HUNDREDAW: f"{locationType.HUNDREDAW}",
            locationType.PL: f"{locationType.PL}",
            locationType.DC: f"{locationType.DC}",
            locationType.HT: f"{locationType.HT}",
            locationType.PR: f"{locationType.PR}",
            locationType.SP: f"{locationType.SP}",
            locationType.TWTNW: f"{locationType.TWTNW}",
        },
        shared=True,
        default=[
            locationType.STT,
    ...
    Toggle(
        name=settingkey.ATTACK_DATA_RANDOMIZATION,
        group=SettingGroup.COMPANIONS,
        ui_label="Randomize all Attack Data",
        shared=True,
        default=False,
        tooltip="""
        If enabled, data for various attacks will be randomized.
        Which data is randomized can be customized
        """,
        randomizable=False,
    ),
    Toggle(
    ...
    SingleSelect(
        name=settingkey.ATTACK_DATA_DAMAGE_PRESET,
        group=SettingGroup.COMPANIONS,
        ui_label="Damage randomization preset",
        choices=AttackDataPresets.attack_data_preset_options(),
        shared=True,
        default=attackDataPresets.WEAK,
    ...
    SingleSelect(
        name=settingkey.ATTACK_DATA_KNOCKBACK_AMOUNT_PRESET,
        group=SettingGroup.COMPANIONS,
        ui_label="Knockback randomization preset",
        choices=AttackDataPresets.attack_data_preset_options(),
        shared=True,
        default=attackDataPresets.WEAK,
        tooltip=AttackDataPresets.attack_data_preset_tooltip(),
    ...
    SingleSelect(
        name=settingkey.ATTACK_DATA_REVENGE_VALUE_PRESET,
        group=SettingGroup.COMPANIONS,
        ui_label="Revenge value randomization preset",
        choices=AttackDataPresets.attack_data_preset_options(),
        shared=True,
        default=attackDataPresets.WEAK,
        tooltip=AttackDataPresets.attack_data_preset_tooltip(),
    ...
    SingleSelect(
        name=settingkey.ATTACK_DATA_MULTI_HIT_PRESET,
        group=SettingGroup.COMPANIONS,
        ui_label="Multi hit randomization preset",
        choices=AttackDataPresets.attack_data_preset_options(),
        shared=True,
        default=attackDataPresets.WEAK,
        tooltip=AttackDataPresets.multi_hit_preset_tooltip(),
    ),
    SingleSelect(
            name=settingkey.ATTACK_DATA_HPDRAIN_PRESET,
            group=SettingGroup.COMPANIONS,
            ui_label="HP Gain randomization preset",
            choices=AttackDataPresets.attack_data_preset_options(),
            shared=True,
            default=attackDataPresets.WEAK,
            tooltip=AttackDataPresets.hpdrain_preset_tooltip(),
        ),
    SingleSelect(
            name=settingkey.ATTACK_DATA_DRIVEGAIN_PRESET,
            group=SettingGroup.COMPANIONS,
            ui_label="Drive gain randomization preset",
            choices=AttackDataPresets.attack_data_preset_options(),
            shared=True,
            default=attackDataPresets.WEAK,
            tooltip=AttackDataPresets.attack_data_preset_tooltip(),
    ...
    SingleSelect(
        name=settingkey.COOP_HINT_TYPE,
        group=SettingGroup.HINTS,
        ui_label="Co-op Progression Hint Type",
        choices= {
            "default":"Same Order",
            "random":"Random Order",
        ...
        shared=True,
        default="default",
        tooltip="Type of hint changes for coop",
    ),
    Toggle(
        name=settingkey.COOP_HINTS_ENABLED,
        group=SettingGroup.HINTS,
        ui_label="Enable Co-op Hints",
        shared=True,
        default=False,
        tooltip="If enabled, allows for generating two different sets of hints for two players.",
    ),
    SingleSelect(
        name=settingkey.COOP_PLAYER1_HINT_SYSTEM,
        group=SettingGroup.HINTS,
        ui_label="Co-op Player 1 Hints",
        choices= {
            HintType.SHANANAS: "Shananas",
            HintType.JSMARTEE: "JSmartee",
            HintType.POINTS: "Points",
        ...
        shared=True,
        default=HintType.SPOILER,
        tooltip="What hint system should player 1 use?",
    ),    
    SingleSelect(
        name=settingkey.COOP_PLAYER2_HINT_SYSTEM,
        group=SettingGroup.HINTS,
        ui_label="Co-op Player 2 Hints",
        choices= {
            HintType.SHANANAS: "Shananas",
            HintType.JSMARTEE: "JSmartee",
            HintType.POINTS: "Points",
        ...
        shared=True,
        default=HintType.SPOILER,
        tooltip="What hint system should player 2 use?",
    ),
    SingleSelect(
        ...
        default="1",
        tooltip="Selecting which player you are when playing co-op",
    ),
]
